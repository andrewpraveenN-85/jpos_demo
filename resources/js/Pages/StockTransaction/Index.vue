...
<template>
  ...
  <Banner />
  <div
    class="w-full flex flex-col items-center justify-start min-h-screen py-8 space-y-8 bg-gray-100 md:px-36 px-8"
  >
    <Header />
    <div class="md:w-5/6 w-full py-12 space-y-24">
      ...
      <div class="flex w-full">
        <div class="flex items-center w-full h-16 space-x-4 rounded-2xl">
          ...
          <p class="md:text-4xl text-2xl font-bold tracking-wide text-black uppercase">
            Stock Transitions
          </p>
        </div>
