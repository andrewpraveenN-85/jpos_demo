            ...
            <template v-if="allhistoryTransactions && allhistoryTransactions.length > 0">
                ...
                <table
                    ...
                    <tr class="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 text-[12px] text-white border-b border-blue-700">
                        ...
                        <th class="p-4 font-semibold tracking-wide text-left uppercase">Job ID</th>
                        <th class="p-4 font-semibold tracking-wide text-left uppercase">Total Amount</th>
                        <th class="p-4 font-semibold tracking-wide text-left uppercase"> Service Status</th>
                        ...
                        >
                            ...
                            <td class="p-4 font-bold border-gray-200">Job - {{ history.id || "N/A" }}</td>
                             ...
                             <td class="p-4 font-bold border-gray-200">
                                ...
                                {{ history.status == 0 ? "Pending" : history.status == 1 ? "Done" : "N/A" }}
    ...
    <body>
      ...
      <div class="header">
        ...
        <div class="totals">
            ...
            <div>
                <span>Total</span>
                <span>${(parseFloat(history.total_amount) + parseFloat(history.custom_discount || 0) - parseFloat(history.discount || 0)).toFixed(2)}LKR</span>
            </div>
            <div>
                <span>Cash</span>
            ...
            <div>
                <span>Balance</span>
                <span>${(parseFloat(history.cash || 0) -(parseFloat(history.total_amount || 0) -parseFloat(history.discount || 0) +parseFloat(history.custom_discount || 0))).toFixed(2)} LKR</span>
            </div>
        </div>
