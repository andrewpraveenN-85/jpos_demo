<template>
  ...
  <div>
    ...
    <input
      ...
      class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
    />
    <span v-if="form.errors.size" class="text-sm text-red-500">{{ form.errors.size }}</span>
  </div>
  ...
  <div>
    ...
    <input
      ...
      required
    />
    <span v-if="form.errors.selling_price" class="text-sm text-red-500">{{ form.errors.selling_price }}</span>
  </div>
 ...
 <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
  <div class="w-full max-w-md p-4 bg-white rounded-lg shadow-lg">
    <h2 class="text-2xl font-bold text-center text-gray-700">Scan a Barcode</h2>
    <input
      type="text"
      v-model="barcodeData"
      @input="handleBarcodeInput"
      placeholder="Scan your barcode here"
      class="w-full px-4 py-2 mt-4 text-lg text-gray-700 bg-gray-100 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-500"
      autofocus
    />
    <p v-if="scannedData" class="mt-4 text-center text-green-500">
