...
<!-- Size Select -->
          <div>
            ...
            <span v-if="form.errors.size_id" class="text-sm text-red-500">{{ form.errors.size_id }}</span>
          </div>
          ...
          <div>
            ...
            <span v-if="form.errors.color_id" class="text-sm text-red-500">{{ form.errors.color_id }}</span>
          </div>
