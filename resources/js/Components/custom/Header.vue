<template>
  ...
  <div class="w-full flex justify-between items-center space-x-8 md:hidden">
    ...
    <div class="hidden md:flex items-center justify-between w-full space-x-4 px-4 py-2">
  <!-- Logo -->
  <Link
    href="/"
    :title="
