...
<td>${product.name}
                    ${product.returnReason ? `<br><small style="color: black; font-weight: bold;">Reason: ${product.returnReason}</small>` : ""}
                </td>
      ...
      ${companyInfo?.value?.phone ||
                ...
                ? `<p>${companyInfo.value.phone || ""} | ${companyInfo.value.phone2 || ""
        ...
        ${props.is_return_bill === 1 && props.return_date
        ? `<div style="font-weight: bold; border: 1px solid black; text-align: center; padding: 5px; margin: 8px 0;">
             <small style="display: block;"> Return Bill : ${props.return_date} </small>
           </div>`
        : ""}


                <div style="font-weight: bold; border: 1px solid black; text-align: center; padding: 5px; margin: 8px 0;">
                    <small style="display: block;"> ${props.status === 0 ? "Pending" : "Done"}
                        </small>
                </div>
