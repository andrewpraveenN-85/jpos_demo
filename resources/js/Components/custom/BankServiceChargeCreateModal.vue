          ...
          <DialogPanel class="bg-black border-4 border-blue-600 rounded-[20px] shadow-xl w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 p-8 text-center">
              ...
              <form @submit.prevent="submit">
                ...
                <div class="mt-6 space-x-4">
                  ...
                  <button type="button" class="px-4 py-2 text-gray-700 bg-gray-300 rounded hover:bg-gray-400"
                          @click="closeModal">
                    Cancel
                  </button>
                </div>
...
defineProps({
  ...
  serviceCharge: { type: Array, required: true },
});
