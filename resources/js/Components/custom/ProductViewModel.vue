<template>
                            ...
                            <div class="flex justify-center w-full h-full p-4 space-x-8 items-start-center">
                                ...
                                <div class="w-1/2">
                                    <img :src="selectedProduct.image
                                        ...
                                        " alt="Product Image" class="object-cover h-full rounded-2xl" />
                                </div>
    ...
    <span v-if="selectedProduct.discount && selectedProduct.discount > 0"
          class="inline-block px-4 py-2 text-xl font-medium text-white bg-red-600 rounded">
        {{ selectedProduct.discount }}% OFF
                                        ...
                                        <div class="flex items-center justify-between w-full pb-6 text-2xl">
                                            ...
                                            <div class="flex flex-col w-full" v-if="selectedProduct.discount && selectedProduct.discount > 0">
    ...
    {{
        ...
        selectedProduct.discount > 0
            ...
            : selectedProduct.selling_price
                                        ...
                                        <div class="mt-2">
                                            <input hidden type="text" id="barcodeInput"
                            ...
                            <div class="w-full">
                                ...
                                <div :class="{ hidden: !isVisible }" class="relative print-container"
                                    id="printContainer">
                                    <div class="flex items-center justify-center w-full space-x-4">
                                        <p class="text-lg font-bold text-black">{{ selectedProduct.category.name }}</p>
                                        <p class="text-lg font-bold text-black">{{ selectedProduct.selling_price }} LKR
                                        </p>
                                    </div>
                                    <!-- <div
