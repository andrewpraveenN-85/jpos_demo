<template>
            ...
            <div class="fixed inset-0 z-10 flex items-center justify-center">
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 scale-95"
                    ...
                    <DialogPanel
                        ...
                        <!-- Dialog -->
                        <TransitionRoot as="template" :show="isDialogOpen" @close="closeDialog">
                                        ...
                                        <DialogPanel
                                            ...
                                            <div class="bg-gray-100 p-6">
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <form v-if="dialogType === 'size'" @submit.prevent="submitSize">
                                                        <label class="block text-md font-bold text-gray-700">Size
                                                            Name:</label>
                                                        <input v-model="sizeForm.sizeName" type="text" required
                                                            class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-blue-600" />
                                                        <span v-if="sizeForm.errors.sizeName" class="mt-2 text-red-500">
                                                    ...
                                                    <form v-if="dialogType === 'color'" @submit.prevent="submitColor">
                                                        <label class="block text-md font-bold text-gray-700">Color
                                                            Name:</label>
                                                        <input v-model="colorForm.colorName" type="text" required
                                                            class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-green-600" />
                                                        <span v-if="colorForm.errors.colorName"
                                                    ...
                                                    <form v-if="dialogType === 'category'"
                                                        @submit.prevent="submitCategory">
                                                        <label class="block text-md font-bold text-gray-700">Category
                                                            Name:</label>
                                                        <input v-model="categoryForm.categoryName" type="text" required
                                                            class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-purple-600" />
                                                        <label class="block text-md font-bold text-gray-700 mt-4">Parent
                                                            Category:</label>
                                                        ...
                                                        <span v-if="categoryForm.errors.parent_id"
                                                            class="mt-2 text-red-500">
  ...
  <div class="w-1/2">
    ...
    <div>
      ...
      <span v-if="form.errors.category_id" class="mt-2 text-red-500">{{ form.errors.category_id }}</span>
    </div>
  </div>
  ...
  <div class="w-1/2">
    ...
    <div>
      ...
      <select v-model="form.supplier_id" id="parent_id"
        class="w-full px-4 py-2 mt-2 text-black bg-white rounded-md focus:outline-none focus:ring focus:ring-blue-600">
      ...
      <span v-if="form.errors.supplier_id" class="mt-2 text-red-500">{{ form.errors.supplier_id }}</span>
    </div>
  </div>
</div>
                                ...
                                <div class="flex items-center gap-8">
                                    <div class="w-full">
                                        <label class="block text-sm font-medium text-gray-300">Bar code:</label>
                                    ...
                                    <div v-if="isPharma" class="w-full">
                                        <label class="block text-sm font-medium text-gray-300">Expire Date:</label>
                                        <input v-model="form.expire_date" type="date" id="barcode"
                                            placeholder="Enter Barcode"
                                            class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-blue-600" />
...
<span v-if="form.errors.branch_id" class="mt-4 text-red-500">
    {{ form.errors.branch_id }}
                                ...
                                <div>
                                    <div class="flex items-center gap-8">
                                        ...
                                        <div class="w-full">
                                            ...
                                            required  class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-blue-600"
                                ...
                                <div>
                                    <div class="flex items-center gap-8">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select v-model="form.size_id" id="parent_id"
                                                class="w-full px-4 py-2 mt-2 text-black bg-white rounded-md focus:outline-none focus:ring focus:ring-blue-600">
                                            ...
                                            <span v-if="form.errors.parent_id" class="mt-2 text-red-500">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select v-model="form.color_id" id="sub_id"
                                                class="w-full px-4 py-2 mt-2 text-black bg-white rounded-md focus:outline-none focus:ring focus:ring-blue-600">
                                ...
                                <div class="flex items-center gap-8 mt-6">
                                    ...
                                    <div class="w-full">
                                        <label for="stock_quantity"
                                            class="block text-sm font-medium text-gray-300">Stock Quantity:</label>
                                ...
                                <div class="flex items-center gap-8 mt-6">
                                    <div class="w-full">
                                        ...
                                        <input type="text" id="selling_price" v-model="form.selling_price"
                                            class="w-full px-4 py-2 mt-2 text-black bg-white rounded-md focus:outline-none focus:ring focus:ring-blue-600"
                                            placeholder="Enter selling price" @blur="updateDiscountedPrice" required />
                                ...
                                <div class="flex items-center gap-8 mt-6">
                                    <div class="w-full">
                                        <label for="image"
                                            class="block text-sm font-medium text-gray-300">Image:</label>
                            ...
                            <div class="mt-6 space-x-4">
                                <button class="px-10 py-2 text-white bg-blue-600 rounded hover:bg-blue-700"
                                    type="submit">
                                    Save
                                </button>
                                <button class="px-10 py-2 text-gray-700 bg-gray-300 rounded hover:bg-gray-400" @click="
                                    () => {
