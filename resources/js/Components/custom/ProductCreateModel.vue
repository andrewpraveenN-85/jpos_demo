        ...
        <DialogPanel class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
          <div class="bg-gray-100 p-6">
            ...
            <DialogTitle class="text-lg font-medium leading-6 text-gray-900">
              {{ dialogType === 'size' ? 'Add Size' : dialogType === 'color' ? 'Add Color' : 'Add Category' }}
            </DialogTitle>

            <div class="mt-4">
              <!-- Conditional Rendering of Forms -->
              <form v-if="dialogType === 'size'" @submit.prevent="submitSize">
                <label class="block text-md font-bold text-gray-700">Size Name:</label>
                <input
              ...
              <form v-if="dialogType === 'color'" @submit.prevent="submitColor">
                <label class="block text-md font-bold text-gray-700">Color Name:</label>
                <input
                ...
                <span v-if="colorForm.errors.colorName" class="mt-2 text-red-500">
              ...
              <form v-if="dialogType === 'category'" @submit.prevent="submitCategory">
                <label class="block text-md font-bold text-gray-700">Category Name:</label>
                <input
                  v-model="categoryForm.categoryName"
                  type="text"
                  required
                  class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-purple-600" />
                <label class="block text-md font-bold text-gray-700 mt-4">Parent Category:</label>
                <select
                ...
                <span v-if="categoryForm.errors.parent_id" class="mt-2 text-red-500">
                   ...
                   <form @submit.prevent="submit">
                      ...
                      <div class="mt-6 space-y-4 text-left">
                         ...
                         <div>
                            ...
                            <input v-model="form.barcode" type="text" id="barcode" placeholder="Enter Barcode"
                               class="w-full px-4 py-2 mt-2 text-black rounded-md focus:outline-none focus:ring focus:ring-blue-600" />
                      ...
                      <div class="mt-6 space-x-4">
                         ...
                         <button class="px-4 py-2 text-gray-700 bg-gray-300 rounded hover:bg-gray-400" @click="() => {
